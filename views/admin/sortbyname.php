	...
	for ($i = 1;
		...
		if ($i == $arg1['current_page']){
            ...
            <div class="pagination">
                <a style="color: #ff0c09; text-decoration: none;" href="<?php echo URL ?>admin/sortbyname/<?php echo $i; ?>"><?php echo $i; ?></a>
            </div>
			<?php
		}else{
			?>
            <div class="pagination">
                <a href="<?php echo URL ?>admin/sortbyname/<?php echo $i; ?>"><?php echo $i; ?></a>
            </div>
			<?php
		}
	}?>
