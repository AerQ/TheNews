...
<section class="user-login">
	...
	?>
                        ...
                        <input type="text" name="user_name" placeholder="Введите логин..." class="form-control" id="user_name">

                        <label for="user_password">Пароль:</label>
                        <input type="password" placeholder="Введите пароль..." class="form-control" name="user_password" id="user_password">
